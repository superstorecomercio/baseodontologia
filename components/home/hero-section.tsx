...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-x-hidden pt-[calc(4.5rem+0.5rem)] pb-3 max-sm:pb-2.5 sm:pt-[calc(4.5rem+0.75rem)] sm:pb-8 lg:pt-[calc(5rem+0.5rem)] lg:pb-10">
      ...
      <div className="relative page-container">
         ...
         */}
        <div className="grid gap-x-0 gap-y-3 py-3 max-sm:gap-y-2 max-sm:py-2 sm:gap-y-9 sm:py-10 lg:grid-cols-[minmax(0,1fr)_min(42%,26rem)] lg:items-center lg:gap-x-12 lg:gap-y-0 lg:py-12 xl:grid-cols-[minmax(0,1fr)_28rem] xl:gap-x-16">
          <div className="hero-lcp-col relative order-1 flex justify-center lg:col-start-2 lg:row-start-1 lg:row-span-2 lg:justify-end lg:pb-0">
            <div className="relative w-full max-w-full sm:max-w-[19rem] md:max-w-[20rem] lg:max-w-full">
          ...
          <div className="hero-fade-item hero-fade-item--1 order-2 min-w-0 text-center lg:col-start-1 lg:row-start-1 lg:text-left">
            <div className="mb-2 inline-flex max-w-full items-center gap-1.5 rounded-full bg-primary/10 px-3 py-1.5 text-left text-[11px] font-semibold tracking-wide text-primary max-sm:mb-1.5 max-sm:leading-snug sm:mb-6 sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
            ...
            <h1 className="mb-2 font-serif text-[1.5rem] font-semibold tracking-tight text-balance leading-[1.1] text-foreground max-sm:mb-1.5 max-sm:leading-[1.08] sm:mb-6 sm:text-3xl sm:leading-[1.12] md:text-4xl md:leading-[1.1] lg:mb-6 lg:text-[2.375rem] lg:leading-[1.08] xl:text-[2.5rem]">
            ...
            <div className="mx-auto max-w-xl text-pretty text-[13px] leading-snug text-muted-foreground max-sm:text-xs max-sm:leading-snug sm:text-base sm:leading-relaxed md:text-lg md:leading-relaxed lg:mx-0 lg:mb-8">
